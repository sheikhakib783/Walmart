                        ...
                        <div class="prt_04 mb-2">
                            ...
                            <div class="text-left">
                                ...
                                <div class="form-check form-option form-check-inline mb-1">
                                        ...
                                        <label class="form-option-label rounded-circle" for="white{{$color->color_id}}"><span class="form-option-color rounded-circle" style="background-color:{{$color->rel_to_color->color_code}}"></span></label>
                                    </div>  
                                @endforeach                        
                            </div>
                        </div>
                    ...
                    @forelse ($releted_products as $releted_product)                    
                        ...
                        <div class="single_itesm">
                            <div class="product_grid card b-0 mb-0">
                                @if ($releted_product->discount)										
                                <div class="badge bg-info text-white position-absolute ft-regular ab-left text-upper">Sale</div>
                                <div class="badge bg-danger text-white position-absolute ft-regular ab-right text-upper">-{{$releted_product->discount}}%</div>
                                @endif
                                <div class="card-body p-0">
                                    <div class="shop_thumb position-relative">
                                        <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('uploads/product/preview')}}/{{$releted_product->preview}}" alt="..."></a>
                                    </div>
                                </div>
                                <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
                                    <div class="text-left">
                                        <div class="text-center">
                                            <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html">{{$releted_product->product_name}}</a></h5>
                                            <div class="elis_rty">
                                                @if ($releted_product->discount)
                                                <span class="ft-medium text-muted line-through fs-md mr-2">&#2547;{{$releted_product->price}}</span>
                                                @endif
                                                <span class="ft-bold theme-cl fs-lg mr-2">&#2547;{{$releted_product->after_discount}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
